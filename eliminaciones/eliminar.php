...
<nav>
	<?php 
		nav_administrador_eliminar();
 	?>
</nav>

<section class="section_alter">

	<p class="mensaje">Elija la tabla <br> que desea eliminar </p>
		...
		if  ($numrows5!=0) 
					{
						...
						echo "<form name='form1' ACTION='eliminacion.php' METHOD='POST'>";
						...
						while ($row = pg_fetch_array($result1)) {						
					    		...
					    		echo "<p class=".$type2.">Tabla de ".$tabla."</p>";    
					    		echo "<tr>";			
